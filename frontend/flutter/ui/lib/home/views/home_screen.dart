...
import 'package:ui/home/utils/utils.dart';
import 'package:ui/home/widgets/widgets.dart';
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Image.asset(
                    'lib/home/assets/images/menu.png',
                    height: 30,
                ...
                itemBuilder: (context, index) {
                  return SmartDeviceBoxWidget(
                    ...
                    onChanged: (bool newValue) async {
                      ...
                      String path = AppData.smartDevices[index][3];
                      bool isSent = await ClientApi.writeActuator(
                        path,
                        newValue,
                      );
                      if (!isSent) {
